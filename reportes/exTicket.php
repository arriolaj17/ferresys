...
<table border="0" align="center" width="300px">
    ...
    <tr>
        <td><?php echo $reg->tipo_documento.": ".$reg->nro_documento; ?></td>
    </tr>
    <tr>
        <td>Nº de venta: <?php echo $reg->serie_comprobante." - ".$reg->nro_comprobante ; ?></td>
    </tr>    
</table>
<br>
...
<table border="0" align="center" width="300px">
    ...
    <tr>
      <td colspan="3" align="center">FerreSys</td>
    </tr>
    <tr>
      <td colspan="3" align="center">Guarambaré - Paraguay</td>
    </tr>
