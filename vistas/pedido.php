              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST" action="compra.php" method="POST">
                            ...
                            <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                              <thead style="background-color:#A9D0F5">
                                ...
                                <tfoot>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th><h4 id="total">Gs/. 0.00</h4><input type="hidden" name="monto_total" id="monto_total"></th>
                                </tfoot>
                                <tbody>
